  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Streamlining Employee Management, Vacation Tracking, and Payroll Processing for Enhanced Business Efficiency."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Streamlining Employee Management, Vacation Tracking, and Payroll Processing for Enhanced Business Efficiency.`}
            </Text>
            <Box
